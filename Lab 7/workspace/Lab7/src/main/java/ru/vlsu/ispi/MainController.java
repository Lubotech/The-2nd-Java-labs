...
import ru.vlsu.ispi.dao.StudentDAO;
...
public class MainController {
	...
	private StudentDAO studentDAO;
	  ...
	  @PostMapping("/student")
	  public String studentSubmit(@Valid @ModelAttribute Student student, BindingResult result, Model model) {
		  if(result.hasErrors()) {
			  return "student";
		  }
		  studentDAO.create(student);
		  model.addAttribute(studentDAO.getAll());
		  return "students";
	  }
